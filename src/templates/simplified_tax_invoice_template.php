...
require 'invoice_billing_reference_template.php';
    ...
    <cac:AccountingSupplierParty>
        <cac:Party>
            ...
            <cac:PostalAddress>
                ...
                <cbc:BuildingNumber>SET_BUILDING_NUMBER</cbc:BuildingNumber>SET_PLOT_IDENTIFICATION
...
__ActualDeliveryDateSET_PAYMENT_REFERENCE
    PARSE_LINE_ITEMS
</Invoice>
XML;
